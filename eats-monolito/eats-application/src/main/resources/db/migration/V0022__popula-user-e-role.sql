...
-- senha: 123456
insert into USUARIO (name, password) values ('admin', '{bcrypt}$2a$10$3Qrx0rv8qSmZ8s3RlD5qE.upleP7.Qzbg5EoIAm62evEkY4c023TK');
insert into USUARIO (name, password) values ('longfu', '{bcrypt}$2a$10$3Qrx0rv8qSmZ8s3RlD5qE.upleP7.Qzbg5EoIAm62evEkY4c023TK');
