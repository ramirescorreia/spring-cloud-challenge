...
-- senha: 123456
insert into USUARIO (id, name, password) values (1, 'admin', '{bcrypt}$2a$10$3Qrx0rv8qSmZ8s3RlD5qE.upleP7.Qzbg5EoIAm62evEkY4c023TK');
insert into USUARIO (id, name, password) values (2, 'longfu', '{bcrypt}$2a$10$3Qrx0rv8qSmZ8s3RlD5qE.upleP7.Qzbg5EoIAm62evEkY4c023TK');
